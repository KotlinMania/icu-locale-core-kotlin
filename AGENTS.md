...
This file is the quick-reference operating contract for icu-locale-core-kotlin. The longer
...
icu-locale-core-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`icu_locale_core`](https://crates.io/crates/icu_locale_core). Upstream Rust is the behavioral oracle while the
