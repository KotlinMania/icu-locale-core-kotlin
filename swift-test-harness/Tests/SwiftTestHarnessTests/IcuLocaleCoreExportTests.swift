...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `IcuLocaleCore.swiftmodule/`
...
//      `import IcuLocaleCore` above would fail at compile time.
//
//   2. The static archive `libIcuLocaleCore.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "IcuLocaleCore" }` and
//      `flattenPackage = "io.github.kotlinmania.iculocalecore"` configuration in
...
//      via the `IcuLocaleCoreLibrary` product.
//
...
final class IcuLocaleCoreExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "IcuLocaleCore swift module imported cleanly")
    }
}
