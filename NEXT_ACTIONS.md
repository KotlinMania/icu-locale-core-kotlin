...
- **Function parity:** 145/301 matched (target 504) — 48.2%
- **Class/type parity:** 24/57 matched (target 80) — 42.1%
- **Combined symbol parity:** 169/358 matched (target 584) — 47.2%
...
- **Functions:** 7/11 matched (target 17)
...
- **Functions:** 0/1 matched (target 8)
...
- **Functions:** 7/21 matched (target 18)
...
- **Functions:** 8/18 matched (target 14)
...
- **Functions:** 7/13 matched (target 15)
...
- **Functions:** 3/9 matched (target 5)
...
- **Functions:** 9/13 matched (target 18)
...
- **Target:** `keywords.KeywordsTest [STUB]`
- **Similarity:** 0.00
- **Dependents:** 0
- **Priority Score:** 10.0
