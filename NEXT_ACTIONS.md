...
- **Function parity:** 145/333 matched (target 584) — 43.5%
- **Class/type parity:** 24/59 matched (target 90) — 40.7%
- **Combined symbol parity:** 169/392 matched (target 674) — 43.1%
...
1. **macros.enum_keyword** (13 deps)
   - Path: `src/preferences/extensions/unicode/macros/enum_keyword.rs`
...
- **Target:** `iculocalecore.Locale [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 5
...
- **Target:** `subtags.Region [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 2
...
- **Target:** `subtags.Script [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 1
...
- **Target:** `subtags.Language [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 1
...
- **Target:** `iculocalecore.LanguageIdentifier [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
...
- **Provenance warning:** port-lint provenance header matched only by basename: `tests:preferences/extensions/unicode/keywords/mod.rs` vs expected `extensions/mod.rs`
- **Proposed provenance header:** `// port-lint: source extensions/mod.rs` (current: `// port-lint: source extensions/mod.rs`)
- **Proposed provenance header:** `// port-lint: tests extensions/mod.rs` (current: `// port-lint: tests preferences/extensions/unicode/keywords/mod.rs`)
- **Lint issues:** 2
...
|--------|-----------------|------|-------------|---------------|
| `benches.fixtures.mod` | `benches.fixtures.Mod` | 0 | `benches/fixtures/mod.rs` | `benches/fixtures/Mod.kt` |
| `helpers.mod` | `benches.helpers.Mod` | 0 | `benches/helpers/mod.rs` | `benches/helpers/Mod.kt` |
| `lib` | `Lib` | 0 | `src/lib.rs` | `Lib.kt` |
| `preferences.extensions.mod` | `preferences.extensions.Mod` | 0 | `src/preferences/extensions/mod.rs` | `preferences/extensions/Mod.kt` |
| `keywords.mod` | `preferences.extensions.unicode.keywords.Mod` | 0 | `src/preferences/extensions/unicode/keywords/mod.rs` | `preferences/extensions/unicode/keywords/Mod.kt` |
| `macros.mod` | `preferences.extensions.unicode.macros.Mod` | 0 | `src/preferences/extensions/unicode/macros/mod.rs` | `preferences/extensions/unicode/macros/Mod.kt` |
| `preferences.extensions.unicode.mod` | `preferences.extensions.unicode.Mod` | 0 | `src/preferences/extensions/unicode/mod.rs` | `preferences/extensions/unicode/Mod.kt` |
| `fixtures.mod` | `tests.fixtures.Mod` | 0 | `tests/fixtures/mod.rs` | `tests/fixtures/Mod.kt` |
